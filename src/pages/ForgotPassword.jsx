      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form onSubmit={handelSubmit}>
            <input type='email' id='email' value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email Adresse" className='w-full mb-6 px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out' />
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              ...
              <p className='className=mb-6'><Link to='/sign-in' className='text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out'>Sign In instead</Link></p>
            </div>
